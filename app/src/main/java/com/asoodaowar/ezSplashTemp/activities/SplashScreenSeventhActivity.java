...
public class SplashScreenSeventhActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_splash_screen_seventh);
    ...
    private void bottomProgressDots(int current_index) {
        ...
        if (dots.length > 0) {
            ...
            dots[current_index].setColorFilter(getResources().getColor(R.color.pink_A800), PorterDuff.Mode.SRC_IN);
        }
    }
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = layoutInflater.inflate(R.layout.item_splash_screen_seventh, container, false);
