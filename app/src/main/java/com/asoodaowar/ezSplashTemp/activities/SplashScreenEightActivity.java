...
public class SplashScreenEightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_splash_screen_eigth);
    ...
    private void initComponent() {
        ...
        btnDone =  findViewById(R.id.btn_got_it);
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = layoutInflater.inflate(R.layout.item_splash_screen_eight, container, false);
